		...
		<form class="form-vertical login-form" action="login.php" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="roll_no"/>
					</div>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="create-account">
				<p>
					...
					<a href="creategroup.php" id="register-btn" >Create an group</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
